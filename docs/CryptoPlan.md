...
| [x] | Secure buffer | 1 | `Memory/SecureBuffer.hpp`, `Memory/Secret.hpp`, `Memory/SecretView.hpp` | `Memory/SecureBuffer.cpp` | Move, wipe, resize, allocator tests | Move-only secret storage with explicit expose/view APIs. |
