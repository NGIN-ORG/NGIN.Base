...
namespace NGIN::Crypto::Asymmetric
{
    ...
    [[nodiscard]] NGIN_CRYPTO_API CryptoExpected<X25519KeyPair> GenerateX25519KeyPair(
    ...
    [[nodiscard]] NGIN_CRYPTO_API CryptoExpected<void> DeriveX25519SharedSecretInto(
    ...
    [[nodiscard]] NGIN_CRYPTO_API CryptoExpected<X25519SharedSecret> DeriveX25519SharedSecret(
            const NGIN::Crypto::Backend::CryptoContext& context,
            const X25519PrivateKey&                     privateKey,
