...
#if defined(NGIN_IORUNTIME_SHARED_BUILD)
#define NGIN_IORUNTIME_API NGIN_DETAIL_EXPORT_API
#elif defined(NGIN_IORUNTIME_SHARED)
#define NGIN_IORUNTIME_API NGIN_DETAIL_IMPORT_API
#else
#define NGIN_IORUNTIME_API
#endif
