...
int main()
{
    ...
    Benchmark::Register([](BenchmarkContext& ctx) {
        ...
        for (int i = 0; i < 1000; ++i) map.Insert(keys[i], keys[i]);
        int sum = 0;
        rng.seed(43);
        std::shuffle(keys.begin(), keys.end(), rng);
        for (int i = 0; i < 1000; ++i) sum += map.Get(keys[i]);
        ctx.doNotOptimize(sum);
        ctx.stop();
    ...
    Benchmark::Register([](BenchmarkContext& ctx) {
        ...
        std::mt19937 rng(43);
        std::shuffle(keys.begin(), keys.end(), rng);
        for (int i = 0; i < 1000; ++i) map.Remove(keys[i]);
        ctx.stop();
    ...
    Benchmark::Register([](BenchmarkContext& ctx) {
        ...
        for (int i = 0; i < 1000; ++i) cmap.Insert(i, i);
        int sum = 0;
        for (int i = 0; i < 1000; ++i) sum += cmap.Get(i);
        ctx.doNotOptimize(sum);
        ctx.stop();
    ...
    Benchmark::Register([](BenchmarkContext& ctx) {
        ...
        std::mt19937 rng(44);
        std::shuffle(keys.begin(), keys.end(), rng);
        for (int i = 0; i < 1000; ++i) cmap.Insert(keys[i], keys[i]);
        int sum = 0;
        rng.seed(45);
        std::shuffle(keys.begin(), keys.end(), rng);
        for (int i = 0; i < 1000; ++i) sum += cmap.Get(keys[i]);
        ctx.doNotOptimize(sum);
        ctx.stop();
    ...
    Benchmark::Register([](BenchmarkContext& ctx) {
        ...
        NGIN::Containers::ConcurrentHashMap<int, int> cmap;
        for (int i = 0; i < 1000; ++i) cmap.Insert(i, i);
        for (int i = 0; i < 1000; ++i) cmap.Remove(i);
        ctx.stop();
    ...
    Benchmark::Register([](BenchmarkContext& ctx) {
        ...
        std::mt19937 rng(45);
        std::shuffle(keys.begin(), keys.end(), rng);
        for (int i = 0; i < 1000; ++i) cmap.Remove(keys[i]);
        ctx.stop();
    ...
    Benchmark::Register([](BenchmarkContext& ctx) {
        ...
        for (int i = 0; i < 1000; ++i) map.Insert(i, i);
        int sum = 0;
        for (int i = 0; i < 1000; ++i) sum += map.Get(i);
        for (int i = 0; i < 1000; i += 2) map.Remove(i);
        for (int i = 0; i < 1000; ++i) if (map.Contains(i)) sum += map.Get(i);
        ctx.doNotOptimize(sum);
        ctx.stop();
    ...
    Benchmark::Register([](BenchmarkContext& ctx) {
        ...
        int sum = 0;
        for (int i = 0; i < 1000; ++i) sum += cmap.Get(i);
        for (int i = 0; i < 1000; i += 2) cmap.Remove(i);
        for (int i = 0; i < 1000; ++i) if (cmap.Contains(i)) sum += cmap.Get(i);
        ctx.doNotOptimize(sum);
        ctx.stop();
