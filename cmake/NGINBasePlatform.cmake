...
function(ngin_base_link_platform_libraries)
  ...
  if(WIN32)
    if(MSVC)
      ngin_base_link_if_target(NGIN.Base.Static PUBLIC Synchronization Ws2_32 Bcrypt)
      ngin_base_link_if_target(NGIN.Base.Shared PRIVATE Synchronization Ws2_32 Bcrypt)
    else()
